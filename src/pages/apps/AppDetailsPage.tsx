...
const AppDetailsPage = () => {
  ...
  const { data: appGroups, isLoading: isAppGroupsLoading } = useQuery({
    ...
    queryFn: () =>
      appService.getAppGroup({ appId, page: groupPage, size: pageSize }),
  });

  // Fetch scopes attached users
  const { data: appAttachedGroups, isLoading: isAppAttachedGroupsLoading } =
    useQuery({
  ...
  const { data: appAvailableGroups, isLoading: isAppAvailableGroupsLoading } =
    useQuery({
